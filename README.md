...
1. Get code and enter project: `git clone https://github.com/striblab/20171028-stp_mayoral_race.git && cd 20171028-stp_mayoral_race.git`
...
2. Copy files (update path as needed): `mkdir -p ../20171028-stp_mayoral_race/ && rsync -rav ./ ../20171028-stp_mayoral_race/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
